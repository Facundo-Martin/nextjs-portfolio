...
Our navbar component was silently making **four duplicate calls** to the `/trpc/public.allClasses` endpoint—effectively fetching our entire lesson catalog multiple times on every page load!
